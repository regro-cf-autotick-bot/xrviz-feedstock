...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xrviz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6958&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xrviz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xrviz` can be installed with:

```
conda install xrviz
```

It is possible to list all of the versions of `xrviz` available on your platform with:
